...
class PageWrap extends Component {
  ...
  createLoadAnim({target}) {
    ...
    //get the elements
    let loader = target.find({name: 'loader'});

    return new TimelineLite()
      //fade out
      .to(loader, 0.3, {autoAlpha: 1})
  }

  createLoadOutAnim({target}) {

    //get the elements
    let loader = target.find({name: 'loader'});

    return new TimelineLite({onComplete: this.loadOutAnimDone.bind(this)})
      //fade out
      .to(loader, 0.3, {autoAlpha: 0})
      //restore to original
      // .set(loader, {clearProps:"all"})
      // .set(dot, {clearProps:"all"})
  }
  ...
  onPageStarting() {
    ...
    if(!this.state.loading) {
      this.controller = this.addAnimation(this.createLoadAnim.bind(this));
  ...
  onPageLoadComplete() {
    ...
    this.controller = this.addAnimation(this.createLoadOutAnim.bind(this));
  }
          ...
          return (
            <div className={`page-wrapper ${this.props.wrappedPage}`}>
              ...
              <div>
               ...
               <div name="loader-bg" className="loader-bg">
                  <div name="loader" className="loader">
...
export default connect(mapStateToProps)(GSAP()(PageWrap));
